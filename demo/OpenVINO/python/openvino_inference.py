...
def parse_args() -> argparse.Namespace:
    ...
    args.add_argument(
        "-i", "--input", required=True, type=str, help="Required. Path to an image file."
    )
    args.add_argument(
        "-o", "--output_dir", type=str, default="demo_output", help="Path to your output dir."
    )
    args.add_argument(
        "-s",
        "--score_thr",
    ...
    args.add_argument(
        "--labels", default=None, type=str, help="Option:al. Path to a labels mapping file."
    )
    args.add_argument(
        "-nt", "--number_top", default=10, type=int, help="Optional. Number of top results."
    )
